...
<form action="<%=path%>/WebSiteController" method="post">
	<table class="table">
		...
		<tr>
			<td>网站描述</td>
			<td><input type="text" name="descrption" value="${website.descrption}"/></td>
		</tr>
		<tr>
			<td>网站版权</td>
		...
		<tr>
			...
			<td colspan=2 style="text-align:center"><input type="hidden" name="id" value="${website.id }" /><input type="submit" value="提交"/></td>
		</tr>
	</table>
</form>
</div>
